...
export declare class MovieController {
    ...
    update(id: string, dto: CreateMovieDto): Promise<import("mongoose").Document<Types.ObjectId, import("@typegoose/typegoose/lib/types").BeAnObject, import("./movie.model").MovieModel> & import("./movie.model").MovieModel & import("@typegoose/typegoose/lib/types").IObjectWithTypegooseFunction & Required<{
        _id: Types.ObjectId;
    }>>;
